...
procedure Main is
   ...
   type Equipos is (Madrid, Barsa, Betis, Villareal, Getafe);
   ...
   --  procedure Swap(Can1 : in out Cantidad_Jugadores; Can2 : in out Cantidad_Jugadores) is
